public class SimpleQueue {
    public static void Run() {
        ...
        // Defect(s) Found: Trying to remove data from index 1 instead of 0 which is the actual first place of index
        ...
        value = queue.Dequeue();
        Console.WriteLine(value);
        // Defect(s) Found: The enqueues function was inserting at the front of the queues
